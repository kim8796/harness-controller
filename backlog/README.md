...
- `v1.8.8` external controller 는 implementation run 뒤에도 backlog 를 자동 완료하지 않는다. `target backlog transition` dry-run 후 `--apply` 에서만 sidecar backlog 상태를 바꾼다.
