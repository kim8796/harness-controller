...
현재 기준은 `v1.8.21` 이다. 전체 변경 이력은 [VERSION.md](VERSION.md), export 계약은 [FRAMEWORK_EXPORT.md](FRAMEWORK_EXPORT.md), 하네스 개발자용 큰 그림은 [../../harness_guide.md](../../harness_guide.md)를 본다.
