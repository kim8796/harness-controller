...
`v1.8.7` controller hotfix 는 worktree/branch 실행 정책을 바꾸지 않는다. Controller bundle CI 에 필요한 `requirements.txt` 만 controller export surface 에 포함하고 starter export 에서는 제외한다.
