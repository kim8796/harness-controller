...
`v1.8.8` external controller backlog transition 은 product worktree/branch 를 바꾸지 않는다. Sidecar backlog state 만 dry-run-first 명령에서 바꾸며 product commit/push 는 별도 gate 다.
