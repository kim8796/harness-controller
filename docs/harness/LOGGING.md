...
v1.8.7 부터 controller release hotfix evidence 는 controller bundle 의 `requirements.txt` 포함, starter bundle 의 `requirements.txt` 제외, controller sanitization pass, private controller GitHub Actions pass 여부를 함께 남긴다.
