...
- Hardened autopilot product commit staging with literal Git pathspecs, nested directory policy scans, deletion staging, `HARNESS_GIT_AUTHOR_*` identity fallback, and Korean blocker explanations.
