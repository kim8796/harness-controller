    ...
    *,
    ...
    return "\n".join(
        [
            ...
            "- Spec budget: Do not open full goal spec files during implementation; the selected backlog Summary/Acceptance is the contract.",
            "- If the backlog contract is impossible to understand without the full spec, leave product files unchanged and report that blocker.",
            "- Image attachment policy: Do not call `view_image`, screenshot, or other image-opening tools during implementation runs.",
            "- Use listed captions and attachment filenames as visual direction. Leave pixel-level visual inspection to a later review task.",
            "- If a later visual QA task explicitly requires image inspection, inspect at most 3 representative attachments with default/resized detail; never open original-resolution images.",
            "",
